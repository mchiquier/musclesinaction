...
send-keys "CUDA_VISIBLE_DEVICES=1 python musclesinaction/inference_id_transf_cond_exercises_emgtopose.py \
--name generalization_new_cond_ElbowPunch_clean_baseline_perex \
--std False \
--threed True \
--predemg False \
--cond False \
--resume checkpoints/generalization_new_nocond_ElbowPunch_clean_emgtopose/model_100.pth \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=0 python musclesinaction/inference_id_transf_cond_exercises_emgtopose.py \
--name generalization_new_cond_Running_clean_baseline_perex \
--std False \
--threed True \
--predemg False \
--cond False \
--resume checkpoints/generalization_new_nocond_Running_clean_emgtopose/model_100.pth \
...
--cond False \
--predemg False \
--resume checkpoints/generalization_new_nocond_RonddeJambe_clean_emgtopose/model_100.pth \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=2 python musclesinaction/inference_id_transf_cond_exercises_emgtopose.py \
--name generalization_new_cond_LegCross_clean_baseline_perex \
--std False \
--threed True \
--cond False \
--predemg False \
--resume checkpoints/generalization_new_nocond_LegCross_clean_emgtopose/model_100.pth \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=3 python musclesinaction/inference_id_transf_cond_exercises_emgtopose.py \
--name generalization_new_cond_LegBack_clean_baseline_perex \
--std False \
--threed True \
--cond False \
--predemg False \
--resume checkpoints/generalization_new_nocond_LegBack_clean_emgtopose/model_100.pth \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=4 python musclesinaction/inference_id_transf_cond_exercises_emgtopose.py \
--name generalization_new_cond_KneeKick_clean_baseline_perex \
--std False \
--threed True \
--cond False \
--predemg False \
--resume checkpoints/generalization_new_nocond_KneeKick_clean_emgtopose/model_100.pth \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=5 python musclesinaction/inference_id_transf_cond_exercises_emgtopose.py \
--name generalization_new_cond_JumpingJack_clean_baseline_perex \
--std False \
--threed True \
--cond False \
--predemg False \
--resume checkpoints/generalization_new_nocond_JumpingJack_clean_emgtopose/model_100.pth \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=6 python musclesinaction/inference_id_transf_cond_exercises_emgtopose.py \
--name generalization_new_cond_HookPunch_clean_baseline_perex \
--std False \
--threed True \
--predemg False \
--cond False \
--resume checkpoints/generalization_new_nocond_HookPunch_clean_emgtopose/model_100.pth \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=7 python musclesinaction/inference_id_transf_cond_exercises_emgtopose.py \
--name generalization_new_cond_HighKick_clean_baseline_perex \
--std False \
--cond False \
--threed True \
--predemg False \
--resume checkpoints/generalization_new_nocond_HighKick_clean_emgtopose/model_100.pth \
...
--predemg False \
--cond False \
--resume checkpoints/generalization_new_nocond_FrontPunch_clean_emgtopose/model_100.pth \
...
--predemg False \
--cond False \
--resume checkpoints/generalization_new_nocond_FrontKick_clean_emgtopose/model_100.pth \
...
--predemg False \
--cond False \
--resume checkpoints/generalization_new_nocond_Shuffle_clean_emgtopose/model_100.pth \
...
--cond False \
--predemg False \
--resume checkpoints/generalization_new_nocond_SideLunges_clean_emgtopose/model_100.pth \
...
--cond False \
--predemg False \
--resume checkpoints/generalization_new_nocond_SlowSkater_clean_emgtopose/model_100.pth \
...
--cond False \
--predemg False \
--resume checkpoints/generalization_new_nocond_Squat_clean_emgtopose/model_100.pth \
