...
--cond True \
--predemg False \
--resume checkpoints/generalization_new_cond_Ishaan_clean_emgtopose/model_50.pth \
...
--cond True \
--predemg False \
--resume checkpoints/generalization_new_cond_Sruthi_clean_emgtopose/model_50.pth \
...
--cond True \
--predemg False \
--resume checkpoints/generalization_new_cond_Sonia_clean_emgtopose/model_50.pth \
...
--predemg False \
--cond True \
--resume checkpoints/generalization_new_cond_Samir_clean_emgtopose/model_50.pth \
...
--cond True \
--predemg False \
--resume checkpoints/generalization_new_cond_David_clean_emgtopose/model_50.pth \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=5 musclesinaction/inference_id_transf_cond_exercises_emgtopose.py \
--name generalization_new_nocond_Jo_clean_baseline \
--std False \
--threed True \
--cond True \
--predemg False \
--resume checkpoints/generalization_new_cond_Jo_clean_emgtopose/model_50.pth \
...
--cond True \
--predemg False \
--resume checkpoints/generalization_new_cond_Jonny_clean_emgtopose/model_50.pth \
...
--predemg False \
--cond True \
--resume checkpoints/generalization_new_cond_Lionel_clean_emgtopose/model_50.pth \
...
--cond True \
--predemg False \
--resume checkpoints/generalization_new_cond_Me_clean_emgtopose/model_50.pth \
...
--predemg False \
--cond True \
--resume checkpoints/generalization_new_cond_Serena_clean_emgtopose/model_50.pth \
