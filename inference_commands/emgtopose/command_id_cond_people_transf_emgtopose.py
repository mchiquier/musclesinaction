...
send-keys "CUDA_VISIBLE_DEVICES=0 python musclesinaction/inference_id_transf_cond_exercises_emgtopose.py.py \
--name generalization_new_cond_David_clean_baseline_perex \
--std False \
--threed True \
--cond True \
--predemg False \
--resume checkpoints/generalization_new_cond_clean_emgtopose_threed/model_100.pth \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=1 python musclesinaction/inference_id_transf_cond_exercises_emgtopose.py.py \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=2 python musclesinaction/inference_id_transf_cond_exercises_emgtopose.py.py \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=3 python musclesinaction/inference_id_transf_cond_exercises_emgtopose.py.py \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=4 python musclesinaction/inference_id_transf_cond_exercises_emgtopose.py.py \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=5 python musclesinaction/inference_id_transf_cond_exercises_emgtopose.py.py \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=6 python musclesinaction/inference_id_transf_cond_exercises_emgtopose.py.py \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=7 python musclesinaction/inference_id_transf_cond_exercises_emgtopose.py.py \
