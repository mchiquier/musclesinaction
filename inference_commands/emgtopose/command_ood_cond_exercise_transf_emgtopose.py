...
--cond True \
--predemg False \
--resume checkpoints/generalization_new_cond_Squat_clean_emgtopose/model_100.pth \
...
--predemg False \
--cond True \
--resume checkpoints/generalization_new_cond_ElbowPunch_clean_emgtopose/model_100.pth \
...
--predemg False \
--cond True \
--resume checkpoints/generalization_new_cond_Running_clean_emgtopose/model_100.pth \
...
--cond True \
--predemg False \
--resume checkpoints/generalization_new_cond_RonddeJambe_clean_emgtopose/model_100.pth \
...
--cond True \
--predemg False \
--resume checkpoints/generalization_new_cond_LegCross_clean_emgtopose/model_100.pth \
...
--cond True \
--predemg False \
--resume checkpoints/generalization_new_cond_LegBack_clean_emgtopose/model_100.pth \
...
--cond True \
--predemg False \
--resume checkpoints/generalization_new_cond_KneeKick_clean_emgtopose/model_100.pth \
...
--cond True \
--predemg False \
--resume checkpoints/generalization_new_cond_JumpingJack_clean_emgtopose/model_100.pth \
...
--predemg False \
--cond True \
--resume checkpoints/generalization_new_cond_HookPunch_clean_emgtopose/model_100.pth \
...
--threed True \
--predemg False \
--resume checkpoints/generalization_new_cond_HighKick_clean_emgtopose/model_100.pth \
...
--predemg False \
--cond True \
--resume checkpoints/generalization_new_cond_FrontPunch_clean_emgtopose/model_100.pth \
...
--predemg False \
--cond True \
--resume checkpoints/generalization_new_cond_FrontKick_clean_emgtopose/model_100.pth \
...
--predemg False \
--cond True \
--resume checkpoints/generalization_new_cond_Shuffle_clean_emgtopose/model_100.pth \
...
--cond True \
--predemg False \
--resume checkpoints/generalization_new_cond_SideLunges_clean_emgtopose/model_100.pth \
...
--cond True \
--predemg False \
--resume checkpoints/generalization_new_cond_SlowSkater_clean_emgtopose/model_100.pth \
