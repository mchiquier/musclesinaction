...
--name correctsruthi_ood_nocond_LegCross_std \
--data_path_train ../../../vondrick/mia/VIBE/correctsruthioodfiles/sruthi_nocond_ood_train_LegCross.txt \
...
--name correctsruthi_ood_nocond_RonddeJambe_std \
--data_path_train ../../../vondrick/mia/VIBE/correctsruthioodfiles/sruthi_nocond_ood_train_RonddeJambe.txt \
...
--name correctsruthi_ood_nocond_Running_std \
--data_path_train ../../../vondrick/mia/VIBE/correctsruthioodfiles/sruthi_nocond_ood_train_Running.txt \
...
--name correctsruthi_ood_nocond_Shuffle_std \
--data_path_train ../../../vondrick/mia/VIBE/correctsruthioodfiles/sruthi_nocond_ood_train_Shuffle.txt \
...
--name correctsruthi_ood_nocond_SideLunges_std \
--data_path_train ../../../vondrick/mia/VIBE/correctsruthioodfiles/sruthi_nocond_ood_train_SideLunges.txt \
...
--name correctsruthi_ood_nocond_SlowSkater_std \
--data_path_train ../../../vondrick/mia/VIBE/correctsruthioodfiles/sruthi_nocond_ood_train_SlowSkater.txt \
...
--name correctsruthi_ood_nocond_Squat_std \
--data_path_train ../../../vondrick/mia/VIBE/correctsruthioodfiles/sruthi_nocond_ood_train_Squat.txt \
