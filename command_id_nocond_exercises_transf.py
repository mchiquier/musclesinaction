...
--name generalization_test_nocond_Running_clean_baseline_perex \
--std False \
--threed True \
--predemg True \
--cond False \
--resume checkpoints/generalization_test_nocond_clean_posetoemg/latestcheckpoint.pth \
...
--name generalization_test_nocond_RonddeJambe_clean_baseline_perex \
--std False \
--threed True \
--cond False \
--predemg True \
...
--name generalization_test_nocond_LegCross_clean_baseline_perex \
--std False \
--threed True \
--cond False \
--predemg True \
...
--name generalization_test_nocond_LegBack_clean_baseline_perex \
--std False \
--threed True \
--cond False \
--predemg True \
...
--name generalization_test_nocond_KneeKick_clean_baseline_perex \
--std False \
--threed True \
--cond False \
--predemg True \
...
--name generalization_test_nocond_JumpingJack_clean_baseline_perex \
--std False \
--threed True \
--cond False \
--predemg True \
...
--name generalization_test_nocond_HookPunch_clean_baseline_perex \
--std False \
--threed True \
--predemg True \
--cond False \
...
--name generalization_test_nocond_HighKick_clean_baseline_perex \
--std False \
--cond False \
--threed True \
--predemg True \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=0 python musclesinaction/knn_id_transf_cond_exercises.py \
--name generalization_test_nocond_FrontPunch_clean_baseline_perex \
--std False \
--threed True \
--predemg True \
--cond False \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=1 python musclesinaction/knn_id_transf_cond_exercises.py \
--name generalization_test_nocond_FrontKick_clean_baseline_perex \
--std False \
--threed True \
--predemg True \
--cond False \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=1 python musclesinaction/knn_id_transf_cond_exercises.py \
--name generalization_test_nocond_ElbowPunch_clean_baseline_perex \
--std False \
--threed True \
--predemg True \
--cond False \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=2 python musclesinaction/knn_id_transf_cond_exercises.py \
--name generalization_test_nocond_Shuffle_clean_baseline_perex \
--std False \
--threed True \
--predemg True \
--cond False \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=3 python musclesinaction/knn_id_transf_cond_exercises.py \
--name generalization_test_nocond_SideLunges_clean_baseline_perex \
--std False \
--threed True \
--cond False \
--predemg True \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=4 python musclesinaction/knn_id_transf_cond_exercises.py \
--name generalization_test_nocond_SlowSkater_clean_baseline_perex \
--std False \
--threed True \
--cond False \
--predemg True \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=5 python musclesinaction/knn_id_transf_cond_exercises.py \
--name generalization_test_nocond_Squat_clean_baseline_perex \
--std False \
--threed True \
--cond False \
--predemg True \
