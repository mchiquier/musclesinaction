...
--name generalization_test_cond_clean_posetoemg \
--std False \
--predemg True \
--threed True \
...
--name generalization_test_cond_clean_emgtopose_threed \
--predemg False \
--threed True \
--learn_rate 0.0005 \
--std False \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=1 python musclesinaction/train.py \
--name generalization_test_cond_clean_emgtopose_twod \
--predemg False \
--threed False \
--std False \
--learn_rate 0.0005 \
...
--name generalization_test_nocond_clean_posetoemg \
--std False \
--predemg True \
--cond False \
--threed True \
...
--name generalization_test_nocond_clean_emgtopose_threed \
--predemg False \
--threed True \
--learn_rate 0.0005 \
--cond False \
...
--name generalization_test_nocond_clean_emgtopose_twod \
--predemg False \
--threed False \
--std False \
--cond False \
