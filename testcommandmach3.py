...
--name correctsruthi_ood_nocond_ElbowPunch_std \
--data_path_train ../../../vondrick/mia/VIBE/correctsruthioodfiles/sruthi_nocond_ood_train_ElbowPunch.txt \
...
--name correctsruthi_nocond_FrontKick_std \
--data_path_train ../../../vondrick/mia/VIBE/correctsruthioodfiles/sruthi_nocond_ood_train_FrontKick.txt \
...
--name correctsruthi_ood_nocond_FrontPunch_std \
--data_path_train ../../../vondrick/mia/VIBE/correctsruthioodfiles/sruthi_nocond_ood_train_FrontPunch.txt \
...
--name correctsruthi_ood_nocond_HighKick_std \
--data_path_train ../../../vondrick/mia/VIBE/correctsruthioodfiles/sruthi_nocond_ood_train_HighKick.txt \
...
--name correctsruthi_ood_nocond_HookPunch_std \
--data_path_train ../../../vondrick/mia/VIBE/correctsruthioodfiles/sruthi_nocond_ood_train_HookPunch.txt \
...
--name correctsruthi_ood_nocond_JumpingJack_std \
--data_path_train ../../../vondrick/mia/VIBE/correctsruthioodfiles/sruthi_nocond_ood_train_JumpingJack.txt \
...
--name correctsruthi_ood_nocond_LegBack_std \
--data_path_train ../../../vondrick/mia/VIBE/correctsruthioodfiles/sruthi_nocond_ood_train_LegBack.txt \
...
--name correctsruthi_ood_nocond_KneeKick_std \
--data_path_train ../../../vondrick/mia/VIBE/correctsruthioodfiles/sruthi_nocond_ood_train_KneeKick.txt \
