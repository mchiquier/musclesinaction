...
--cond False \
--predemg True \
--resume pretrained-checkpoints/generalization_new_nocond_clean_posetoemg/model_100.pth \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=7 python musclesinaction/inference_scripts/inference_scripts/inference_id_transf_cond_exercises.py \
