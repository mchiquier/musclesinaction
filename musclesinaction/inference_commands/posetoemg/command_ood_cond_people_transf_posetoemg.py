...
--name generalization_new_cond_Subject2_clean_baseline \
--std False \
--threed True \
--predemg True \
--resume pretrained-checkpoints/generalization_new_cond_Subject2_clean/model_100.pth \
...
--name generalization_new_cond_Subject10_clean_baseline \
--std False \
--threed True \
--predemg True \
--resume pretrained-checkpoints/generalization_new_cond_Subject10_clean/model_100.pth \
...
--name generalization_new_cond_Subject9_clean_baseline \
--std False \
--threed True \
--predemg True \
--resume pretrained-checkpoints/generalization_new_cond_Subject9_clean/model_100.pth \
...
--name generalization_new_cond_Subject7_clean_baseline \
--std False \
--threed True \
--predemg True \
--resume pretrained-checkpoints/generalization_new_cond_Subject7_clean/model_100.pth \
...
--name generalization_new_cond_Subject1_clean_baseline \
--std False \
--threed True \
--predemg True \
--resume pretrained-checkpoints/generalization_new_cond_Subject1_clean/model_100.pth \
...
--name generalization_new_cond_Subject3_clean_baseline \
--std False \
--threed True \
--predemg True \
--resume pretrained-checkpoints/generalization_new_cond_Subject3_clean/model_100.pth \
...
--name generalization_new_cond_Subject4_clean_baseline \
--std False \
--threed True \
--predemg True \
--resume pretrained-checkpoints/generalization_new_cond_Subject4_clean/model_100.pth \
...
--name generalization_new_cond_Subject5_clean_baseline \
--std False \
--threed True \
--predemg True \
--resume pretrained-checkpoints/generalization_new_cond_Subject5_clean/model_100.pth \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=0 python musclesinaction/inference_scripts/inference_id_transf_cond_exercises.py \
--name generalization_new_cond_Subject6_clean_baseline \
--std False \
--threed True \
--predemg True \
--resume pretrained-checkpoints/generalization_new_cond_Subject6_clean/model_100.pth \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=1 python musclesinaction/inference_scripts/inference_id_transf_cond_exercises.py \
--name generalization_new_cond_Subject8_clean_baseline \
--std False \
--threed True \
--predemg True \
--resume pretrained-checkpoints/generalization_new_cond_Subject8_clean/model_100.pth \
