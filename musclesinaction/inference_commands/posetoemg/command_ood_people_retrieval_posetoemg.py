...
--name generalization_test_cond_Subject1_clean_baseline \
--std False \
--threed True \
--predemg True \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=5 musclesinaction/inference_scripts/retrieval_id_nocond_exercises_posetoemg.py \
