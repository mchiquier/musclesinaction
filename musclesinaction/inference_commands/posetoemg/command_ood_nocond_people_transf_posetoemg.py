...
--cond False \
--predemg True \
--resume pretrained-checkpoints/generalization_new_nocond_Subject2_clean/model_100.pth \
...
--cond False \
--predemg True \
--resume pretrained-checkpoints/generalization_new_nocond_Subject10_clean/model_100.pth \
...
--cond False \
--predemg True \
--resume pretrained-checkpoints/generalization_new_nocond_Subject9_clean/model_100.pth \
...
--predemg True \
--cond False \
--resume pretrained-checkpoints/generalization_new_nocond_Subject7_clean/model_100.pth \
...
--cond False \
--predemg True \
--resume pretrained-checkpoints/generalization_new_nocond_Subject1_clean/model_100.pth \
...
--cond False \
--predemg True \
--resume pretrained-checkpoints/generalization_new_nocond_Subject3_clean/model_100.pth \
...
--cond False \
--predemg True \
--resume pretrained-checkpoints/generalization_new_nocond_Subject4_clean/model_100.pth \
...
--predemg True \
--cond False \
--resume pretrained-checkpoints/generalization_new_nocond_Subject5_clean/model_100.pth \
...
--cond False \
--predemg True \
--resume pretrained-checkpoints/generalization_new_nocond_Subject6_clean/model_100.pth \
...
--predemg True \
--cond False \
--resume pretrained-checkpoints/generalization_new_nocond_Subject8_clean/model_100.pth \
