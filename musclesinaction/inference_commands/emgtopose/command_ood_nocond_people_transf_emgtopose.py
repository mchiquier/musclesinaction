...
--cond False \
--predemg False \
--resume checkpoints/generalization_new_nocond_Subject2_clean_emgtopose/model_100.pth \
...
--cond False \
--predemg False \
--resume checkpoints/generalization_new_nocond_Subject10_clean_emgtopose/model_100.pth \
...
--cond False \
--predemg False \
--resume checkpoints/generalization_new_nocond_Subject9_clean_emgtopose/model_100.pth \
...
--predemg False \
--cond False \
--resume checkpoints/generalization_new_nocond_Subject7_clean_emgtopose/model_100.pth \
...
--cond False \
--predemg False \
--resume checkpoints/generalization_new_nocond_Subject1_clean_emgtopose/model_100.pth \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=5 musclesinaction/inference_scripts/inference_id_transf_cond_exercises_emgtopose.py \
--name generalization_new_nocond_Subject3_clean_baseline \
--std False \
--threed True \
--cond False \
--predemg False \
--resume checkpoints/generalization_new_nocond_Subject3_clean_emgtopose/model_100.pth \
...
--cond False \
--predemg False \
--resume checkpoints/generalization_new_nocond_Subject4_clean_emgtopose/model_100.pth \
...
--predemg False \
--cond False \
--resume checkpoints/generalization_new_nocond_Subject5_clean_emgtopose/model_100.pth \
...
--cond False \
--predemg False \
--resume checkpoints/generalization_new_nocond_Subject6_clean_emgtopose/model_100.pth \
...
--predemg False \
--cond False \
--resume checkpoints/generalization_new_nocond_Subject8_clean_emgtopose/model_100.pth \
