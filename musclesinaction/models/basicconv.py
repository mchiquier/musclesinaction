...
class BasicConv(nn.Module):
    ...
    def __init__(self, device):
        ...
        self.conv1 = nn.Conv2d(1,32,(26,9),(1,1),(1,4))
        self.bn1 = nn.BatchNorm2d(32)
        self.conv2 = nn.Conv2d(32,64,(26,9),(1,1),(1,4))
        self.bn2 = nn.BatchNorm2d(64)
        self.conv3 = nn.Conv2d(64,128,(26,9),(1,1),(1,4))
        self.bn3 = nn.BatchNorm2d(128)
        self.conv4 = nn.Conv2d(128,64,(26,9),(1,1),(1,4))
        self.conv5 = nn.Conv2d(64,1,(8,9),(1,1),(1,4))
