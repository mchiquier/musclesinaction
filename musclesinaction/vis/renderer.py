...
class Renderer:
    ...
    def part_segm_to_vertex_colors(self, part_segm, n_vertices, front, emg_values, alpha=1.0):
    ...
    def render(self, img, verts, emg_values, cam, front=True, angle=None, axis=None, mesh_filename=None, color=[0.0, 0.0, 0.0]):
        ...
        vertex_colors = self.part_segm_to_vertex_colors(part_segm, verts.shape[0],front,emg_values)
        if not front:
