...
--name generalization_new_cond_Ishaan_clean_emgtopose \
--std False \
--threed True \
--cond True \
--predemg False \
...
--name generalization_new_cond_Sruthi_clean_emgtopose \
--std False \
--cond True \
--threed True \
--predemg False \
...
--name generalization_new_cond_Sonia_clean_emgtopose \
--std False \
--cond True \
--threed True \
--predemg False \
...
--name generalization_new_cond_Samir_clean_emgtopose \
--std False \
--threed True \
--cond True \
--predemg False \
...
--name generalization_new_cond_David_clean_emgtopose \
--std False \
--threed True \
--cond True \
--predemg False \
...
--name generalization_new_cond_Jo_clean_emgtopose \
--std False \
--threed True \
--cond True \
--predemg False \
...
--name generalization_new_cond_Jonny_clean_emgtopose \
--std False \
--threed True \
--predemg False \
--cond True \
...
--name generalization_new_cond_Lionel_clean_emgtopose \
--std False \
--cond True \
--threed True \
--predemg False \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=0 python musclesinaction/train.py \
--name generalization_new_cond_Me_clean_emgtopose \
--std False \
--threed True \
--predemg False \
--cond True \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=1 python musclesinaction/train.py \
--name generalization_new_cond_Serena_clean_emgtopose \
--std False \
--threed True \
--predemg False \
--cond True \
