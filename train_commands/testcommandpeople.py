...
--name generalization_test_cond_Ishaan_clean \
--std False \
--threed True \
--predemg True \
...
--name generalization_test_cond_Sruthi_clean \
--std False \
--threed True \
--predemg True \
...
--name generalization_test_cond_Samir_clean \
--std False \
--threed True \
--predemg True \
...
--name generalization_test_cond_David_clean \
--std False \
--threed True \
--predemg True \
...
--name generalization_test_cond_Jo_clean \
--std False \
--threed True \
--predemg True \
...
--name generalization_test_cond_Lionel_clean \
--std False \
--threed True \
--predemg True \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=0 python musclesinaction/train.py \
--name generalization_test_cond_Me_clean \
--std False \
--threed True \
--predemg True \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=1 python musclesinaction/train.py \
--name generalization_test_cond_Serena_clean \
--std False \
--threed True \
--predemg True \
