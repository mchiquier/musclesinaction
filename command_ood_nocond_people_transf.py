...
--cond False \
--predemg True \
--resume checkpoints/generalization_new_nocond_Ishaan_clean/model_100.pth \
...
--cond False \
--predemg True \
--resume checkpoints/generalization_new_nocond_Sruthi_clean/model_100.pth \
...
--cond False \
--predemg True \
--resume checkpoints/generalization_new_nocond_Sonia_clean/model_100.pth \
...
--predemg True \
--cond False \
--resume checkpoints/generalization_new_nocond_Samir_clean/model_100.pth \
...
--cond False \
--predemg True \
--resume checkpoints/generalization_new_nocond_David_clean/model_100.pth \
...
--cond False \
--predemg True \
--resume checkpoints/generalization_new_nocond_Jo_clean/model_100.pth \
...
--cond False \
--predemg True \
--resume checkpoints/generalization_new_nocond_Jonny_clean/model_100.pth \
...
--predemg True \
--cond False \
--resume checkpoints/generalization_new_nocond_Lionel_clean/model_100.pth \
...
--cond False \
--predemg True \
--resume checkpoints/generalization_new_nocond_Me_clean/model_100.pth \
...
--predemg True \
--cond False \
--resume checkpoints/generalization_new_nocond_Serena_clean/model_100.pth \
