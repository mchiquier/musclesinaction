...
--predemg True \
--cond True \
--resume checkpoints/generalization_test_cond_Running_clean/model_100.pth \
...
--cond True \
--predemg True \
--resume checkpoints/generalization_test_cond_RonddeJambe_clean/model_100.pth \
...
--cond True \
--predemg True \
--resume checkpoints/generalization_test_cond_LegCross_clean/model_100.pth \
...
--cond True \
--predemg True \
--resume checkpoints/generalization_test_cond_LegBack_clean/model_100.pth \
...
--cond True \
--predemg True \
--resume checkpoints/generalization_test_cond_KneeKick_clean/model_100.pth \
...
--cond True \
--predemg True \
--resume checkpoints/generalization_test_cond_JumpingJack_clean/model_100.pth \
...
--predemg True \
--cond True \
--resume checkpoints/generalization_test_cond_HookPunch_clean/model_100.pth \
...
--threed True \
--predemg True \
--resume checkpoints/generalization_test_cond_HighKick_clean/model_100.pth \
...
--predemg True \
--cond True \
--resume checkpoints/generalization_test_cond_FrontPunch_clean/model_100.pth \
...
--predemg True \
--cond True \
--resume checkpoints/generalization_test_cond_FrontKick_clean/model_100.pth \
...
--predemg True \
--cond True \
--resume checkpoints/generalization_test_cond_ElbowPunch_clean/model_100.pth \
...
--predemg True \
--cond True \
--resume checkpoints/generalization_test_cond_Shuffle_clean/model_100.pth \
...
--cond True \
--predemg True \
--resume checkpoints/generalization_test_cond_SideLunges_clean/model_100.pth \
...
--cond True \
--predemg True \
--resume checkpoints/generalization_test_cond_SlowSkater_clean/model_100.pth \
...
--cond True \
--predemg True \
--resume checkpoints/generalization_test_cond_Squat_clean/model_100.pth \
