...
--name generalization_new_cond_ElbowPunch_clean_emgtopose \
--std False \
--threed True \
--predemg False \
...
--name generalization_new_cond_FrontKick_clean_emgtopose \
--std False \
--threed True \
--predemg False \
...
--name generalization_new_cond_FrontPunch_clean_emgtopose \
--std False \
--threed True \
--predemg False \
...
--name generalization_new_cond_HighKick_clean_emgtopose \
--std False \
--threed True \
--predemg False \
...
--name generalization_new_cond_HookPunch_clean_emgtopose \
--std False \
--threed True \
--predemg False \
...
--name generalization_new_cond_JumpingJack_clean_emgtopose \
--std False \
--threed True \
--predemg False \
...
--name generalization_new_cond_KneeKick_clean_emgtopose \
--std False \
--threed True \
--predemg False \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=0 python musclesinaction/train.py \
--name generalization_new_cond_LegBack_clean_emgtopose \
--std False \
--threed True \
--predemg False \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=1 python musclesinaction/train.py \
--name generalization_new_cond_LegCross_clean_emgtopose \
--std False \
--threed True \
--predemg False \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=2 python musclesinaction/train.py \
--name generalization_new_cond_RonddeJambe_clean_emgtopose \
--std False \
--threed True \
--predemg False \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=3 python musclesinaction/train.py \
--name generalization_new_cond_Running_clean_emgtopose \
--std False \
--threed True \
--predemg False \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=5 python musclesinaction/train.py \
--name generalization_new_cond_Shuffle_clean_emgtopose \
--std False \
--threed True \
--predemg False \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=6 python musclesinaction/train.py \
--name generalization_new_cond_SideLunges_clean_emgtopose \
--std False \
--threed True \
--predemg False \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=7 python musclesinaction/train.py \
--name generalization_new_cond_SlowSkater_clean_emgtopose \
--std False \
--threed True \
--predemg False \
...
"conda activate /proj/vondrick4/mia/condaenvs/vibe-env2" Enter \; \
send-keys "CUDA_VISIBLE_DEVICES=7 python musclesinaction/train.py \
--name generalization_new_cond_Squat_clean_emgtopose \
--std False \
--threed True \
--predemg False \
